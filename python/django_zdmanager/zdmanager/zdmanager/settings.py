"""
Django settings for zdmanager project.
...
SECRET_KEY = '+!6z!&-g)kjytcogt!t9bp$+g*s7npju2%g*vcf-j=0oj+1cre'
...
WSGI_APPLICATION = 'zdmanager.wsgi.application'
